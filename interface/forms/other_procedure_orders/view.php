...
$obj = formFetch("other_procedure_orders", $_GET["id"]);
?>
<form method=post action="<?echo $rootdir?>/forms/other_procedure_orders/save.php?mode=update&id=<?echo $_GET["id"];?>" name="my_form">
<span class="title"><b>Other Procedure Orders</b></span><Br><br>
