...
// Update the deleted column in forms table to remove the injection
$sql_1 = "UPDATE forms set deleted=1 where form_id='" . $id . "' and formdir='" . $formname . "' and pid='" . $pid . "'";
//$sql_1 = "DELETE FROM form_scanned_notes where id='" . $id . "'";
//$sql_2 = "DELETE FROM forms where form_id='" . $id . "' and pid='" . $pid . "'";
