...
$obj = formFetch("test_and_referrals", $_GET["id"]);
?>
<form method=post action="<?echo $rootdir?>/forms/test_and_referrals/save.php?mode=update&id=<?echo $_GET["id"];?>" name="my_form">
<span class="title"><b>Test and Referrals</b></span><Br><br>
