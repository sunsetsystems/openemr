<?php
// Copyright (C) 2020 Rod Roark <rod@sunsetsystems.com>
//
...
// This provides enhancement functions for the LBF_BarrierNew visit form.
...
//
function LBF_BarrierNew_javascript() {
